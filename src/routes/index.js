...
import {
  loginLibSchema,
  registerLibSchema,
} from "../middleware/validation/loginSignupLib.validation.js";

import { memLogin, memSignup } from "../controllers/mem.auth.controller.js";
import { libLogin, libSignup } from "../controllers/lib.auth.controller.js";
...
indexRouter.post(
  "/library/signup",
  generateMiddleWare(registerLibSchema),
  libSignup
);
...
indexRouter.post(
  "/library/login",
  generateMiddleWare(loginLibSchema),
  libLogin
);
